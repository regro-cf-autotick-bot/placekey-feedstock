...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/placekey-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12490&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/placekey-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `placekey` can be installed with:

```
conda install placekey
```

It is possible to list all of the versions of `placekey` available on your platform with:
